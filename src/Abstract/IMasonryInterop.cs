...
public interface IMasonryInterop : IAsyncDisposable
{
    ...
    /// </summary>
    public ValueTask Init(string elementId, string? containerSelector = null, string itemSelector = ".masonry-item", string columnWidthSelector = ".masonry-sizer", bool percentPosition = true,
